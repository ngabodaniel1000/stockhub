...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8889/api/account/reset-password', {
        email,
        otp,
        newPassword
      });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a090e] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-black p-8 rounded-lg shadow-md">
